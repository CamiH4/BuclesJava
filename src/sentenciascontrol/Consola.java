...
public class Consola extends javax.swing.JInternalFrame {
    ...
    OpConsola operacionesc = new OpConsola();
    ...
    private void bRealizar2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_bRealizar2ActionPerformed
        ...
        JOptionPane.showMessageDialog(this, num1 + " / " + num2 + " = " + operacionesc.division(num1, num2), "División", JOptionPane.INFORMATION_MESSAGE);
    ...
    private void bRealizar1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_bRealizar1ActionPerformed
        // TODO add your handling code here:
        double tb = 0;
        tb = Double.parseDouble(JOptionPane.showInputDialog(this, "Ingresa los TB: "));
        JOptionPane.showMessageDialog(this, tb + " terabytes son " + operacionesc.tbByte(tb) + " bytes", "Respuesta", JOptionPane.INFORMATION_MESSAGE);
    ...
    private void bRealizar4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_bRealizar4ActionPerformed
        // TODO add your handling code here:
        int cifra = 0;
        cifra = Integer.parseInt(JOptionPane.showInputDialog("Ingresa los 5 dígitos: "));
        JOptionPane.showMessageDialog(this, operacionesc.sepNumint(cifra));
    ...
    private void bRealizar5ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_bRealizar5ActionPerformed
        ...
        JOptionPane.showMessageDialog(this, "La raiz de " + num + " es: " + operacionesc.calcRaiz(num),"Raiz", JOptionPane.INFORMATION_MESSAGE);
    ...
    private void bRealizar6ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_bRealizar6ActionPerformed
        // TODO add your handling code here:
        JOptionPane.showMessageDialog(this, operacionesc.tablaVerdad(),"Tabla", JOptionPane.INFORMATION_MESSAGE);
    ...
    private void bRealizar7ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_bRealizar7ActionPerformed
        ...
        car1 = String.format(JOptionPane.showInputDialog("Ingresa un caracter: "));
        car2 = String.format(JOptionPane.showInputDialog("Ingresa un caracter: "));
        car3 = String.format(JOptionPane.showInputDialog("Ingresa un caracter: "));
        car4 = String.format(JOptionPane.showInputDialog("Ingresa un caracter: "));
        car5 = String.format(JOptionPane.showInputDialog("Ingresa un caracter: "));
        car6 = String.format(JOptionPane.showInputDialog("Ingresa un caracter: "));
        JOptionPane.showMessageDialog(this, operacionesc.concat(car1, car2, car3, car4, car5, car6), "Concatenación", JOptionPane.INFORMATION_MESSAGE);
    ...
    private void bRealizar8ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_bRealizar8ActionPerformed
        // TODO add your handling code here:
        JOptionPane.showMessageDialog(this, operacionesc.mostrarFecha(),"Fecha", JOptionPane.INFORMATION_MESSAGE);
