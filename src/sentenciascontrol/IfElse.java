...
public class IfElse extends javax.swing.JInternalFrame {
    ...
    OpIfElse operacionesi = new OpIfElse();
    ...
    private void initComponents() {
        ...
        chbLaguna.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                chbLagunaActionPerformed(evt);
            }
        });
        ...
        tfNum10.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                tfNum10ActionPerformed(evt);
            }
        });
    ...
    private void bValidar4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_bValidar4ActionPerformed
        ...
        int n;
        n = Integer.parseInt(tfNum1.getText());

        operacionesi.vEdad(n);
        bValidar4.setText(String.valueOf(operacionesi.v));
    ...
    private void bValidar5ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_bValidar5ActionPerformed
        // TODO add your handling code here:
        double calc;
        calc = Double.parseDouble(tfNum2.getText());

        operacionesi.calValida(calc);
        bValidar5.setText(String.valueOf(operacionesi.r));
    ...
    private void bValidar6ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_bValidar6ActionPerformed
        // TODO add your handling code here:
        double not;
        not = Double.parseDouble(tfNum3.getText());

        operacionesi.vCal(not);
        bValidar6.setText(String.valueOf(operacionesi.a));
    ...
    private void bValidar7ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_bValidar7ActionPerformed
        // TODO add your handling code here:
        int anio;
        anio = Integer.parseInt(tfNum4.getText());

        operacionesi.aBisiesto(anio);
        bValidar7.setText(String.valueOf(operacionesi.resp));
    ...
    private void bCalcular8ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_bCalcular8ActionPerformed
        // TODO add your handling code here:
        int n1, n2, n3, n4;
        n1 = Integer.parseInt(tfNum5.getText());
        n2 = Integer.parseInt(tfNum6.getText());
        n3 = Integer.parseInt(tfNum7.getText());
        n4 = Integer.parseInt(tfNum8.getText());

        operacionesi.vMayor(n1, n2, n3, n4);
        bCalcular8.setText(String.valueOf(operacionesi.m));
    ...
    private void bCalcular9ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_bCalcular9ActionPerformed
        // TODO add your handling code here:
        String mes;
        mes = String.format(tfNum9.getText());

        operacionesi.cDiasMes(mes);
        bCalcular9.setText(String.valueOf(operacionesi.d));
    ...
    private void bMostrar10ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_bMostrar10ActionPerformed
        // TODO add your handling code here:
        String l;
        l = String.format(tfNum10.getText());

        operacionesi.rCal(l);
        bMostrar10.setText(String.valueOf(operacionesi.cal));
    ...
    private void tfNum10ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_tfNum10ActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_tfNum10ActionPerformed
    ...
    private void bMostrar1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_bMostrar1ActionPerformed
        ...
        if (rbSoltero.isSelected()) {
            JOptionPane.showMessageDialog(this, "Soltero(a)");
        } 
        else if (rbCasado.isSelected()) {
            JOptionPane.showMessageDialog(this, "Casado(a)");
        } 
    ...
    private void bMostrar2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_bMostrar2ActionPerformed
        ...
        JOptionPane.showMessageDialog(this, "Opciones: " + op);
        op = "";
    }//GEN-LAST:event_bMostrar2ActionPerformed

    private void chbLagunaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_chbLagunaActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_chbLagunaActionPerformed

    private void bMostrar3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_bMostrar3ActionPerformed
        // TODO add your handling code here:
        String content = null;
        String b = tbOpcion.getName();
        if (content == b){JOptionPane.showMessageDialog(this, "Realizar otra operación");}
